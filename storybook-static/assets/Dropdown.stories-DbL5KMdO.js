...
`,
  o = ({ options: e, value: m, onChange: g, disabled: x }) =>
    s.jsx(v, {
      value: m,
      onChange: (a) => g(a.target.value),
      disabled: x,
      children: e.map((a) =>
        s.jsx("option", { value: a.value, children: a.label }, a.value),
      ),
    });
o.__docgenInfo = {
  description: "",
...
const h = {
    ...
    component: o,
    argTypes: { value: { control: "text" }, disabled: { control: "boolean" } },
  },
  c = (e) => s.jsx(o, { ...e }),
  r = c.bind({});
r.args = {
...
r.parameters = {
  ...
  docs: {
    ...
    source: {
      ...
      ...((d = (i = r.parameters) == null ? void 0 : i.docs) == null
        ? void 0
        : d.source),
    },
  },
...
t.parameters = {
  ...
  docs: {
    ...
    source: {
      originalSource: "args => <Dropdown {...args} />",
      ...((u = (p = t.parameters) == null ? void 0 : p.docs) == null
        ? void 0
        : u.source),
    },
  },
};
const D = ["Default", "Disabled"];
export { r as Default, t as Disabled, D as __namedExportsOrder, h as default };
