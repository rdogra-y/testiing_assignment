...
const n =
  ...
  p = "" + new URL("docs---vsFbMi.png", import.meta.url).href,
  x = "" + new URL("share-DGA-UcQf.png", import.meta.url).href,
  b = "" + new URL("figma-plugin-CH2hELiO.png", import.meta.url).href,
  C = "" + new URL("testing-cbzR9l9r.png", import.meta.url).href,
  f = "" + new URL("accessibility-W_h2acOZ.png", import.meta.url).href,
  u = "" + new URL("theming-D6WJLNoW.png", import.meta.url).href,
  j = "" + new URL("addon-library-BWUCAmyN.png", import.meta.url).href,
  s = () => {
    const t = { path: "path", svg: "svg", ...o() };
    return e.jsx(t.svg, {
      viewBox: "0 0 14 14",
      width: "8px",
      height: "14px",
...
function r(t) {
  const i = { code: "code", h1: "h1", p: "p", ...o(), ...t.components };
  return e.jsxs(e.Fragment, {
    children: [
      e.jsx(a, { title: "Configure your project" }),
      `
`,
      e.jsxs("div", {
...
`,
                          e.jsx(i.code, { children: "staticDirs" }),
          ...
          e.jsxs("div", {
            ...
            children: [
              ...
              e.jsxs("a", {
                ...
                target: "_blank",
                children: ["Discover all addons", e.jsx(s, {})],
              }),
            ],
          }),
          e.jsx("div", {
          ...
          e.jsxs("div", {
            ...
            children: [
              ...
              e.jsxs("a", {
                ...
                target: "_blank",
                children: ["Star on GitHub", e.jsx(s, {})],
              }),
            ],
          }),
          e.jsxs("div", {
              ...
              e.jsxs("div", {
                children: [
                  ...
                  e.jsxs("a", {
                    ...
                    target: "_blank",
                    children: ["Join Discord server", e.jsx(s, {})],
                  }),
                ],
              }),
            ],
              ...
              e.jsxs("div", {
                children: [
                  ...
                  e.jsxs("a", {
                    ...
                    target: "_blank",
                    children: ["Watch on YouTube", e.jsx(s, {})],
                  }),
                ],
              }),
            ],
          ...
          e.jsxs("div", {
            ...
            children: [
              ...
              e.jsxs("a", {
                ...
                target: "_blank",
                children: ["Discover tutorials", e.jsx(s, {})],
              }),
            ],
          }),
        ],
...
function N(t = {}) {
  const { wrapper: i } = { ...o(), ...t.components };
  return i ? e.jsx(i, { ...t, children: e.jsx(r, { ...t }) }) : r(t);
}
export { s as RightArrow, N as default };
