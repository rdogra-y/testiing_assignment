...
function J() {
  ...
  (v.constructor = y), S(v, l.prototype), (v.isPureReactComponent = !0);
  var O = Array.isArray,
  ...
  function R(t, e, n, r, s, f) {
    return (
      (n = f.ref),
      { $$typeof: p, type: t, key: e, ref: n !== void 0 ? n : null, props: f }
    );
  }
  function G(t, e) {
...
var Y;
function V() {
  return Y || ((Y = 1), (m.exports = J())), m.exports;
}
var F = V();
const tt = Z(F);
export { tt as R, V as a, Z as g, F as r };
