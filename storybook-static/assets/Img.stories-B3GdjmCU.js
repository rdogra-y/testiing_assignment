...
const f = b.img`
  ...
  border-radius: ${(e) => {
    var s;
    return ((s = e.theme) == null ? void 0 : s.borderRadius) || "0";
  }};
  ...
  @media (max-width: 480px) {
    max-width: 60%;
`,
  o = ({ src: e, alt: s, width: g, height: u, borderRadius: h, disabled: x }) =>
    m.jsx(f, {
      src: e,
      alt: s,
      width: g,
...
o.__docgenInfo = {
  ...
  props: {
    ...
    borderRadius: {
      required: !1,
      tsType: { name: "string" },
      description: "Border radius for rounded corners (optional)",
    },
    disabled: {
      required: !1,
      tsType: { name: "boolean" },
...
t.parameters = {
  ...
  docs: {
    ...
    source: {
      ...
      ...((d = (i = t.parameters) == null ? void 0 : i.docs) == null
        ? void 0
        : d.source),
    },
  },
...
r.parameters = {
  ...
  docs: {
    ...
    source: {
      originalSource: "args => <Img {...args} />",
      ...((p = (l = r.parameters) == null ? void 0 : l.docs) == null
        ? void 0
        : p.source),
    },
  },
};
const M = ["Default", "Disabled"];
export { t as Default, r as Disabled, M as __namedExportsOrder, H as default };
