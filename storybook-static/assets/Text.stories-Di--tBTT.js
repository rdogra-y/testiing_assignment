...
`,
  c = ({ children: e, color: t, disabled: p }) =>
    m.jsx(u, { $color: t, $disabled: p, children: e });
c.__docgenInfo = {
  description: "",
  methods: [],
  displayName: "Text",
  props: {
    children: {
      required: !0,
      tsType: { name: "string" },
      description: "Text content inside the component",
    },
    color: {
      required: !1,
      tsType: { name: "string" },
...
const h = {
  ...
  r = {
    args: { children: "This text is disabled.", color: "#333", disabled: !0 },
  };
var s, n, a;
o.parameters = {
  ...o.parameters,
  ...
  args: {
    ...
    disabled: false
      ...
      ...((a = (n = o.parameters) == null ? void 0 : n.docs) == null
        ? void 0
        : a.source),
    },
  },
...
const T = ["Default", "Disabled"];
export { o as Default, r as Disabled, T as __namedExportsOrder, h as default };
